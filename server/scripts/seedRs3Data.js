...
const GEAR_ITEMS = [
  ...
  { id: 'cryptbloom_bottom',      name: 'Cryptbloom bottom',             tier: 90, style: 'necromancy', slot: 'legs',  is_power_armour: 0, requirements_json: { Necromancy: 90, Defence: 90 }, acquisition_source: 'boss', source_id: 'croesus', wiki_url: 'https://runescape.wiki/w/Cryptbloom_bottom' },
];
