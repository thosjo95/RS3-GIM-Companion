...
const KEY_QUESTS = [
  ...
  { id: 'ek',    name: 'The Elder Kiln',              priority: 'high',   importance: 'Rewards TokHaar-Kal — top melee cape before Completionist',     unlock: 'TokHaar-Kal cape' },
...
const MILESTONE_ITEMS = [
  { id: 'fc',      name: 'Fire Cape',                 priority: 'high',   category: 'Combat Gear',   importance: 'Best-in-slot cape before TokHaar-Kal. Solo challenge at TzTok-Jad.' },
  { id: 'tkhk',   name: 'TokHaar-Kal',               priority: 'high',   category: 'Combat Gear',   importance: 'Top melee cape. Requires The Elder Kiln quest completion.' },
  ...
  { id: 'bandos', name: 'Bandos armour',              priority: 'high',   category: 'Combat Gear',   importance: 'T65 melee power armour. General Graardor at God Wars Dungeon.' },
