...
const GEAR_ITEMS = [
  ...
  { id: 'scrimshaw_of_vampyrism', name: "Scrimshaw of vampyrism", tier: 0, style: 'melee', slot: 'pocket', is_power_armour: 0, requirements_json: { Strength: 80, Fletching: 92 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Scrimshaw_of_vampyrism' },
  { id: 'superior_scrimshaw_of_vampyrism', name: "Superior scrimshaw of vampyrism", tier: 0, style: 'melee', slot: 'pocket', is_power_armour: 0, requirements_json: { Strength: 80, Fletching: 92 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Superior_scrimshaw_of_vampyrism' },
  { id: 'scrimshaw_of_attack', name: "Scrimshaw of attack", tier: 0, style: 'melee', slot: 'pocket', is_power_armour: 0, requirements_json: { Attack: 85, Fletching: 95 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Scrimshaw_of_attack' },
  { id: 'superior_scrimshaw_of_attack', name: "Superior scrimshaw of attack", tier: 0, style: 'melee', slot: 'pocket', is_power_armour: 0, requirements_json: { Attack: 85, Fletching: 95 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Superior_scrimshaw_of_attack' },
  ...
  { id: 'superior_scrimshaw_of_ranging', name: "Superior scrimshaw of ranging", tier: 0, style: 'ranged', slot: 'pocket', is_power_armour: 0, requirements_json: { Ranged: 85, Fletching: 95 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Superior_scrimshaw_of_ranging' },
  { id: 'scrimshaw_of_ranging', name: "Scrimshaw of ranging", tier: 0, style: 'ranged', slot: 'pocket', is_power_armour: 0, requirements_json: { Ranged: 85, Fletching: 95 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Scrimshaw_of_ranging' },
  ...
  { id: 'superior_scrimshaw_of_magic', name: "Superior scrimshaw of magic", tier: 0, style: 'magic', slot: 'pocket', is_power_armour: 0, requirements_json: { Magic: 85, Fletching: 95 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Superior_scrimshaw_of_magic' },
  { id: 'scrimshaw_of_magic', name: "Scrimshaw of magic", tier: 0, style: 'magic', slot: 'pocket', is_power_armour: 0, requirements_json: { Magic: 85, Fletching: 95 }, acquisition_source: 'crafted', source_id: 'player_owned_ports', wiki_url: 'https://runescape.wiki/w/Scrimshaw_of_magic' },
