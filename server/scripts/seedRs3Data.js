...
const BOSSES = [
  ...
  { id: 'giant_mole',       name: 'Giant Mole',                difficulty: 'early', min_combat_level: 50,
    ...
    drops: [{ name: "Numbing root" }, { name: "Dragon 2h sword" }, { name: "Clingy mole (pet)" }, { name: "Ultra-growth potion (hard mode)" }],
  ...
  { id: 'king_black_dragon', name: 'King Black Dragon',         difficulty: 'early', min_combat_level: 70,
    requirements: { skills: {}, quests: [] },
    drops: [{ name: "Draconic visage" }, { name: "Dragon Rider boots" }, { name: "Dragon Rider gloves" }, { name: "King Black Dragon scale (pet)" }],
  ...
  { id: 'chaos_elemental',  name: 'Chaos Elemental',           difficulty: 'early', min_combat_level: 60,
    ...
    drops: [
      ...
      { name: "Ancient Warriors' equipment (Statius/Vesta/Morrigan/Zuriel pieces)" },
      { name: "Corrupt dragon equipment" },
      { name: "Ribs of Chaos (pet)" },
    ],
  ...
  { id: 'kalphite_queen',   name: 'Kalphite Queen',            difficulty: 'early', min_combat_level: 70,
    requirements: { skills: {}, quests: [] },
    drops: [{ name: "Dragon chainbody" }, { name: "Dragon 2h sword" }, { name: "Lava battlestaff" }, { name: "Kalphite egg (pet)" }],
  ...
  { id: 'dagannoth_kings',  name: 'Dagannoth Kings',           difficulty: 'early', min_combat_level: 80,
    ...
    drops: [
      ...
      { name: "Mud battlestaff" }, { name: "Seercull" }, { name: "Dragon hatchet" },
    ],
  ...
  { id: 'tztok_jad',        name: 'TzTok-Jad (Fight Caves)',   difficulty: 'early', min_combat_level: 80,
    requirements: { skills: {}, quests: [] },
    drops: [{ name: "Fire cape" }, { name: "TzTok-Jad's head" }],
  ...
  { id: 'general_graardor', name: 'General Graardor (Bandos)', difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: { Strength: 70 }, quests: [] },
    drops: [
      { name: "Bandos armour set (helmet, chestplate, tassets, gloves, boots, warshield) (T70 Melee)" },
      { name: "Bandos hilt → Bandos godsword" }, { name: "Godsword shards 1-3" },
    ],
    wiki_url: 'https://runescape.wiki/w/General_Graardor' },

  { id: 'kreearra',         name: "Kree'arra (Armadyl)",        difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: { Ranged: 70 }, quests: [] },
    drops: [
      { name: "Armadyl armour set (helmet, chestplate, chainskirt, gloves, boots, buckler) (T70 Ranged)" },
      { name: "Armadyl hilt → Armadyl godsword" }, { name: "Armadyl's Assault (T70 Ranged)" },
    ],
    wiki_url: "https://runescape.wiki/w/Kree'arra" },

  { id: 'zilyana',          name: 'Commander Zilyana (Saradomin)', difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: { Agility: 70 }, quests: [] },
    drops: [
      { name: "Saradomin sword (T70 Melee)" }, { name: "Saradomin hilt → Saradomin godsword" },
      { name: "Armadyl crossbow (T70 Ranged, and off-hand)" },
    ],
  ...
  { id: 'kril_tsutsaroth',  name: "K'ril Tsutsaroth (Zamorak)", difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: { Constitution: 70 }, quests: [] },
    drops: [
      { name: "Robes of Subjugation set (T70 Magic)" }, { name: "Zamorak spear (T70 Melee)" },
      { name: "Steam battlestaff" }, { name: "Zamorak hilt → Zamorak godsword" },
    ],
  ...
  { id: 'corporeal_beast',  name: 'Corporeal Beast',           difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: {}, quests: ["Summer's End"] },
    drops: [
      { name: "Spirit shield (base)" }, { name: "Holy elixir → Spirit shields" },
      { name: "Arcane sigil → Arcane spirit shield" }, { name: "Divine sigil → Divine spirit shield" },
      { name: "Elysian sigil → Elysian spirit shield" }, { name: "Spectral sigil → Spectral spirit shield" },
    ],
    wiki_url: 'https://runescape.wiki/w/Corporeal_Beast' },

  { id: 'qbd',              name: 'Queen Black Dragon',        difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: { Summoning: 60 }, quests: [] },
    drops: [
      { name: "Royal crossbow components (royal torsion spring/sight/frame/bolt stabiliser)" },
      { name: "Dragonbone upgrade kit" },
      { name: "Dragon kiteshield" },
      { name: "Queen Black Dragon's shackles (trophy)" },
    ],
    wiki_url: 'https://runescape.wiki/w/Queen_Black_Dragon' },

  { id: 'glacors',          name: 'Glacors',                   difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: {}, quests: ['Ritual of the Mahjarrat'] },
    drops: [
      { name: "Steadfast boots (T80 Melee, glacyte)" },
      { name: "Ragefire boots (T80 Magic, glacyte)" },
      { name: "Glaiven boots (T80 Ranged, glacyte)" },
      { name: "Shards of Armadyl → Armadyl battlestaff (T77)" },
    ],
  ...
  { id: 'har_aken',         name: 'Har-Aken (Fight Kiln)',     difficulty: 'mid', min_combat_level: 90,
    ...
    drops: [
      ...
      { name: "TokHaar-Kal-Mor (T80 Necromancy cape)" },
      { name: "Uncut onyx" },
    ],
    wiki_url: 'https://runescape.wiki/w/Har-Aken' },

  { id: 'tormented_demons', name: 'Tormented Demons',          difficulty: 'mid', min_combat_level: 85,
    requirements: { skills: {}, quests: ['While Guthix Sleeps'] },
    drops: [
      { name: "Dragon limbs → Dragon crossbow / Ascension crossbow components" },
      { name: "Dragon claws (main and off-hand, →Chaotic claws)" },
      { name: "Ruined dragon armour slice/lump/shard" },
    ],
    wiki_url: 'https://runescape.wiki/w/Tormented_demon' },

  { id: 'magister',         name: 'The Magister',              difficulty: 'mid', min_combat_level: 100,
    requirements: { skills: { Slayer: 115 }, quests: [] },
    drops: [
      { name: "Phylactery" },
  ...
  { id: 'gwd2',             name: 'Heart of Gielinor (GWD2)',  difficulty: 'mid', min_combat_level: 90,
    requirements: { skills: {}, quests: ['Tales of the God Wars'] },
    drops: [
      { name: "Components for Staff of Sliske / Seren godbow / Zaros godsword (T92, from Telos)" },
      { name: "Reprisal ability codex" },
      { name: "Anima core of Zamorak/Seren/Zaros armour (T80 power, from the four generals)" },
    ],
    wiki_url: 'https://runescape.wiki/w/Heart_of_Gielinor' },

  { id: 'legiones',         name: 'Legiones',                  difficulty: 'mid', min_combat_level: 100,
    requirements: { skills: { Slayer: 95 }, quests: [] },
    drops: [
      { name: "Signets I-VI → Ascension crossbow (T90 Ranged main-hand)" },
  ...
  { id: 'nex',              name: 'Nex',                       difficulty: 'end', min_combat_level: 100,
    requirements: { skills: { Ranged: 70, Strength: 70, Agility: 70, Constitution: 70 }, quests: ['The Dig Site'] },
    drops: [
      { name: "Torva helm / platebody / platelegs / gloves / boots (T80 Melee)" },
      { name: "Pernix cowl / body / chaps / gloves / boots (T80 Ranged)" },
      { name: "Virtus mask / robe top / robe legs / gloves / boots (T80 Magic)" },
  ...
  { id: 'kalphite_king',    name: 'Kalphite King',             difficulty: 'end', min_combat_level: 100,
    ...
    drops: [
      ...
      { name: "Perfect chitin (→ T90 defenders)" },
    ],
  ...
  { id: 'araxxi',           name: 'Araxxor / Araxxi',          difficulty: 'end', min_combat_level: 100,
    ...
    drops: [
      ...
      { name: "Spider legs top/middle/bottom, Araxxi's fang/web/eye" },
    ],
    wiki_url: 'https://runescape.wiki/w/Araxxor' },
  ...
  { id: 'vorago',           name: 'Vorago',                    difficulty: 'end', min_combat_level: 100,
    ...
    drops: [
      ...
      { name: "Tectonic energy (→ Tectonic armour, T90 Magic)" },
      { name: "Ancient Summoning stone (pet unlock)" },
    ],
  ...
  { id: 'solak',            name: 'Solak',                     difficulty: 'end', min_combat_level: 100,
    ...
    drops: [
      ...
      { name: "Blightbound crossbow (T92 Ranged, dual-wield)" },
  ...
  { id: 'nex_aod',          name: 'Nex: Angel of Death',       difficulty: 'end', min_combat_level: 100,
    requirements: { skills: { Attack: 70, Ranged: 70, Constitution: 70, Strength: 70 }, quests: [] },
    drops: [
      { name: "Wand of the Praesul (T92 Magic main-hand)" },
      { name: "Imperium core (T92 Magic off-hand)" },
      { name: "Praesul codex (unlocks a T99 curse)" },
    ],
  ...
  { id: 'rasial',           name: 'Rasial, the First Necromancer', difficulty: 'end', min_combat_level: 100,
    requirements: { skills: { Necromancy: 95, Dungeoneering: 77, Archaeology: 86, Magic: 66, Prayer: 40 }, quests: [] },
    drops: [
      { name: "Omni guard (T92 Necromancy shield)" },
      { name: "Soulbound lantern (T92 Necromancy off-hand)" },
      { name: "Crown/robe top/robe bottom/hand wraps/foot wraps of the First Necromancer (T90 armour)" },
    ],
  ...
  { id: 'telos',            name: 'Telos, the Warden',         difficulty: 'end', min_combat_level: 100,
    requirements: { skills: { Attack: 80, Ranged: 80, Magic: 80, Prayer: 80 }, quests: [] },
    drops: [
      { name: "Dormant Zaros godsword (T92 2H Melee — best-in-slot)" },
      { name: "Dormant Seren godbow (T92 2H Ranged — best-in-slot)" },
      { name: "Dormant Staff of Sliske (T92 2H Magic — best-in-slot)" },
      { name: "Reprisal ability codex" },
    ],
  ...
  { id: 'rise_of_the_six',  name: 'Rise of the Six',           difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: ["The Branches of Darkmeyer"] },
    drops: [
      { name: "Malevolent kiteshield" },
      { name: "Merciless kiteshield" },
      { name: "Vengeful kiteshield" },
      { name: "Unstable malevolent energy (→ Malevolent armour, T90 power Melee)" },
    ],
    wiki_url: 'https://runescape.wiki/w/Rise_of_the_Six' },

  { id: 'zamorak_loe',      name: 'Zamorak, Lord of Chaos',    difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: [] },
    drops: [
      { name: "Vestments of Havoc armour (T95 Melee power)" },
      { name: "Bow of the Last Guardian (T95 Ranged, 3 pieces)" },
      { name: "Chaos Roar ability codex" },
      { name: "Codex of lost knowledge" },
    ],
    wiki_url: 'https://runescape.wiki/w/Zamorak,_Lord_of_Chaos' },

  { id: 'raksha',           name: 'Raksha, the Shadow Colossus', difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: ['Raksha, the Shadow Colossus'] },
    drops: [
      { name: "Fleeting boots (T80 Ranged)" },
      { name: "Shadow spike (upgrades Fleeting/Laceration/Blast Diffusion boots to T90)" },
  ...
  { id: 'kerapac',          name: 'Kerapac, the Bound',        difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: [] },
    drops: [
      { name: "Fractured Staff of Armadyl (T95 2H Magic — hard mode only)" },
      { name: "Kerapac's wrist wraps (T85 Magic gloves)" },
      { name: "Scripture of Jas" },
      { name: "Greater Concentrated Blast codex" },
    ],
  ...
  { id: 'arch_glacor',      name: 'Arch-Glacor',               difficulty: 'end', min_combat_level: 100,
    ...
    drops: [
      ...
      { name: "Leng artefact" },
      { name: "Dark ice shard + Dark ice sliver → Dark ice weapons (T85 Melee)" },
      { name: "Frozen core of Leng (hard mode — upgrades to T95)" },
    ],
    wiki_url: 'https://runescape.wiki/w/Arch-Glacor' },

  { id: 'ambassador',       name: 'The Ambassador (ED3)',      difficulty: 'end', min_combat_level: 100,
    requirements: { skills: { Attack: 95, Ranged: 95, Magic: 95 }, quests: [] },
    drops: [
      { name: "Eldritch crossbow limb/stock/mechanism → Eldritch crossbow (T92 Ranged off-hand)" },
  ...
  { id: 'raids',            name: 'Liberation of Mazcab Raids', difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: [] },
    drops: [
      { name: "Achto Teralith armour (T90 tank Melee)" },
      { name: "Achto Tempest armour (T90 tank Ranged)" },
      { name: "Achto Primeval armour (T90 tank Magic)" },
      { name: "Teci (currency for Achto armour)" },
      { name: "Corruption Blast / Corruption Shot / Onslaught / Storm Shards / Shatter codices" },
    ],
  ...
  { id: 'tzkal_zuk',        name: 'TzKal-Zuk (Fight Cauldron)', difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: [] },
    drops: [
      { name: "Obsidian blade / Magma core / Ancient hilt → Ek-Zekkil (T95 2H Melee, hard mode only)" },
      { name: "Magma Tempest ability codex" },
      { name: "Scripture of Ful" },
      { name: "Igneous stones (→ upgrade TokHaar-Kal capes to Igneous versions)" },
    ],
  ...
  { id: 'croesus',          name: 'Croesus',                   difficulty: 'end', min_combat_level: 0,
    requirements: { skills: {}, quests: [] },
    drops: [
      { name: "Cryptbloom armour pieces (incomplete, T90 tank Magic)" },
      { name: "Scripture of Bik" },
      { name: "Sana's fyrtorch (Woodcutting off-hand)" },
      { name: "Tagga's corehammer (Mining off-hand)" },
    ],
    wiki_url: 'https://runescape.wiki/w/Croesus' },

  { id: 'rex_matriarchs',   name: 'Rex Matriarchs',            difficulty: 'end', min_combat_level: 95,
    requirements: { skills: {}, quests: ['Rex Matriarchs'] },
    drops: [
      { name: "Laniakea's spear (T82 Melee halberd, assembled from components)" },
      { name: "Heart of the Warrior/Archer/Seer/Berserker (→ upgraded rings)" },
      { name: "Occultist's ring (Osseous-exclusive)" },
    ],
  ...
  { id: 'zemouregal_vorkath', name: 'Zemouregal & Vorkath',    difficulty: 'end', min_combat_level: 90,
    requirements: { skills: {}, quests: ['Battle of Forinthry'] },
    drops: [
      { name: "Undead dragonhide armour (T75 tank Ranged)" },
      { name: "Vorkath's spike (→ upgrades to T90 Ranged power armour)" },
      { name: "Invoke Lord of Bones incantation codex" },
      { name: "Zemouregal's nexus (100 kill reward)" },
    ],
  ...
  { id: 'vindicta',          name: 'Vindicta & Gorvek',         difficulty: 'mid', min_combat_level: 90,
    ...
    drops: [
      ...
      { name: 'Dormant anima core of Zaros helm/body/legs (T80 Ranged power)' },
      { name: "Crest of Zaros" },
    ],
  ...
  { id: 'helwyr',            name: 'Helwyr',                    difficulty: 'mid', min_combat_level: 90,
    ...
    drops: [
      ...
      { name: 'Orb of the Cywir elders (T85 Magic off-hand)' },
      { name: 'Dormant anima core of Seren helm/body/legs (T80 Magic power)' },
      { name: "Crest of Seren" },
    ],
  ...
  { id: 'twin_furies',       name: 'Twin Furies',               difficulty: 'mid', min_combat_level: 90,
    ...
    drops: [
      ...
      { name: 'Dormant anima core of Zamorak helm/body/legs (T80 Melee power)' },
  ...
  { id: 'gregorovic',        name: 'Gregorovic',                difficulty: 'mid', min_combat_level: 90,
    ...
    drops: [
      ...
      { name: 'Dormant anima core of Sliske helm/body/legs (T80 power)' },
  ...
  { id: 'rune_dragons',      name: 'Rune Dragons',              difficulty: 'end', min_combat_level: 100,
    requirements: { skills: {}, quests: ['Ritual of the Mahjarrat', 'Fate of the Gods'] },
    drops: [
      { name: 'Steadfast scale / Glaiven wing-tip / Ragefire gland (→ upgrade T85 glacyte boots to T90)' },
      { name: "Kethsi ring (5)" },
  ...
  { id: 'wilderness_slayer', name: 'Wilderness Slayer (Mandrith)', difficulty: 'end', min_combat_level: 120,
    requirements: { skills: { Slayer: 95 }, quests: [] },
    drops: [
      { name: 'Decimation (T87 Ranged) — Wilderness Slayer reward' },
      { name: 'Obliteration (T87 Melee) — Wilderness Slayer reward' },
      { name: 'Annihilation (T87 Magic) — Wilderness Slayer reward' },
      { name: 'Dark onyx core' },
    ],
    wiki_url: 'https://runescape.wiki/w/Mandrith' },
];
...
const GEAR_ITEMS = [
  ...
  { id: 'pernix_quiver', name: "Pernix's quiver", tier: 0, style: 'all', slot: 'ammo', is_power_armour: 0, requirements_json: { Fletching: 99 }, acquisition_source: 'crafted', source_id: 'nex', wiki_url: "https://runescape.wiki/w/Pernix's_quiver" },
  // Melee ammo slot — armour spikes family + Nodon spike harness
  { id: 'nodon_spike_harness', name: 'Nodon spike harness', tier: 90, style: 'melee', slot: 'ammo', is_power_armour: 0, requirements_json: { Attack: 90, Thieving: 108 }, acquisition_source: 'skilling', source_id: null, wiki_url: 'https://runescape.wiki/w/Nodon_spike_harness' },
  { id: 'armour_spikes', name: 'Armour spikes', tier: 0, style: 'melee', slot: 'ammo', is_power_armour: 0, requirements_json: { Smithing: 90 }, acquisition_source: 'crafted', source_id: null, wiki_url: 'https://runescape.wiki/w/Armour_spikes' },
  { id: 'abyssal_armour_spikes', name: 'Abyssal armour spikes', tier: 0, style: 'melee', slot: 'ammo', is_power_armour: 0, requirements_json: { Smithing: 90 }, acquisition_source: 'crafted', source_id: null, wiki_url: 'https://runescape.wiki/w/Abyssal_armour_spikes' },
  { id: 'armour_spikes_alloy', name: 'Armour spikes (alloy)', tier: 0, style: 'melee', slot: 'ammo', is_power_armour: 0, requirements_json: { Smithing: 99 }, acquisition_source: 'crafted', source_id: null, wiki_url: 'https://runescape.wiki/w/Armour_spikes_(alloy)' },
  { id: 'abyssal_armour_spikes_alloy', name: 'Abyssal armour spikes (alloy)', tier: 0, style: 'melee', slot: 'ammo', is_power_armour: 0, requirements_json: { Smithing: 99 }, acquisition_source: 'crafted', source_id: null, wiki_url: 'https://runescape.wiki/w/Abyssal_armour_spikes_(alloy)' },
  ...
  { id: 'grasping_rune_pouch', name: "Grasping rune pouch", tier: 66, style: 'all', slot: 'ammo', is_power_armour: 0, requirements_json: { Magic: 66, Runecrafting: 90 }, acquisition_source: 'crafted', source_id: 'large_rune_pouch', wiki_url: 'https://runescape.wiki/w/Grasping_rune_pouch' },
  ...
  { id: 'devourers_nexus', name: "The Devourer's Nexus", tier: 80, style: 'necromancy', slot: 'ammo', is_power_armour: 0, requirements_json: { Necromancy: 80 }, acquisition_source: 'boss', source_id: 'rasial', wiki_url: 'https://runescape.wiki/w/The_Devourer%27s_Nexus' },
  { id: 'zemouregal_nexus', name: "Zemouregal's nexus", tier: 80, style: 'necromancy', slot: 'ammo', is_power_armour: 0, requirements_json: { Necromancy: 80 }, acquisition_source: 'boss', source_id: 'zemouregal_vorkath', wiki_url: 'https://runescape.wiki/w/Zemouregal%27s_nexus' },
